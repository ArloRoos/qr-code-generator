...
public final class AlgebraicTermTest
{
    @Test
    public void exponentiatedTest()
    {
        final ITerm term = ITerm.of(10, 5);

        assertThat(term.exponentiated(2))
            .isEqualTo(ITerm.of(10, 10));
    }
    
    @Test
    public void multiplyTest()
    {
        final ITerm term1 = ITerm.of(10, 2);
        final ITerm term2 = ITerm.of(5, 3);

        assertThat(term1.multipliedBy(term2))
            .isEqualTo(ITerm.of(50, 5));

        assertThat(term2.multipliedBy(2))
            .isEqualTo(ITerm.of(10, 3));
    }
    ...
    public void divideTest()
    {
        ...
        assertThat(term1.dividedBy(term2))
            .isEqualTo(ITerm.of(2, -1));

        assertThat(term2.dividedBy(2))
            .isEqualTo(ITerm.of(2.5, 3));
    }
    ...
    {
        final ITerm term1 = ITerm.of(10, 2);
        final ITerm term2 = ITerm.of(5, 2);

        assertThat(term1.minus(term2))
            .isEqualTo(ITerm.of(5, 2));
    }
